                    ...
                    @else
                        ...
                        <form action="" method="GET" class="mb-4">
                            ...
                            <select class="form-select" name="kategori_fasilitas" onchange="this.form.submit()">
                                ...
                                <option value="dapur"
                                    {{ request('kategori_fasilitas', $kategori ?? '') == 'dapur' ? 'selected' : '' }}>Dapur
                                </option>
                                <option value="cws"
                                    {{ request('kategori_fasilitas', $kategori ?? '') == 'cws' ? 'selected' : '' }}>
                                    Co-Working Space</option>
                                <option value="mesin_cuci"
                                    {{ request('kategori_fasilitas', $kategori ?? '') == 'mesin_cuci' ? 'selected' : '' }}>
                                    Mesin Cuci</option>
                                <option value="sergun"
                                    {{ request('kategori_fasilitas', $kategori ?? '') == 'sergun' ? 'selected' : '' }}>Serba
                                    Guna</option>
                                <option value="theater"
                                    {{ request('kategori_fasilitas', $kategori ?? '') == 'theater' ? 'selected' : '' }}>
                                    Theater</option>
                            </select>
                        </form>
                                        ...
                                        <form action="{{ route('booking.store') }}" method="POST">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" name="booking_date" required
                                                    min="{{ date('Y-m-d') }}"
                                                    value="{{ $bookingDate ?? old('booking_date') }}">
                                            </div>
                                            <div class="mb-3">
                                                            ...
                                                            <div class="col-6">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox"
                                                                        name="tools[]" value="{{ $tool->name }}"
                                                                        id="tool-{{ $tool->id }}">
                                                                    <label class="form-check-label small"
                                                                        for="tool-{{ $tool->id }}">{{ $tool->name }}</label>
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <x-time-dropdown name="start_time" label="Jam Mulai *"
                                                        required="true" :value="isset($startTime)
                                                            ? str_replace('.', ':', $startTime)
                                                            : null" />
                                                </div>
                                                <div class="col-md-6">
                                                    <x-time-dropdown name="end_time" label="Jam Selesai *"
                                                        required="true" :value="isset($endTime)
                                                            ? str_replace('.', ':', $endTime)
                                                            : null" />
                                                </div>
                                            </div>
                                    ...
                                    <div class="animate-fade-in">
                                        ...
                                        <form action="{{ route('booking.store') }}" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="date" class="form-control" name="booking_date"
                                                        value="{{ $bookingDate ?? old('booking_date') }}" required
                                                        min="{{ date('Y-m-d') }}">
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="form-label">Pilih Sesi Waktu <span
                                                            class="text-danger">*</span></label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <button type="submit" class="btn btn-primary w-100">Booking Mesin
                                                    Cuci</button>
                                            </div>
                                        </form>
                                    </div>
