...
@push('scripts')
    ...
    <body class="">
        ...
        @if (auth()->check() && auth()->user()->role->role_name === 'Resident')
            ...
            <div id="chat-container" class="card shadow-lg d-none animate__animated animate__fadeInUp"
                ...
                <div
                    class="card-header bg-primary text-white py-3 d-flex justify-content-between align-items-center shadow-sm">
                ...
                <div id="chat-box" class="card-body overflow-auto p-3 flex-grow-1" style="background: #f4f7fa;">
                    <div class="d-flex mb-3">
                        <div class="bot-msg p-3 shadow-sm small border" style="max-width: 85%;">
                            Halo! Saya iDorm AI. Saya bisa bantu kamu cek jadwal, lapor kerusakan, atau booking fasilitas.
                            Ada
