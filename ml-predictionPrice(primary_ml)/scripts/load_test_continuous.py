...
# Configuration
BASE_URL = "http://localhost:8002/predict/"
...
def run_load_test():
    ...
    try:
        ...
        print("\nCek dashboard Grafana (http://localhost:3002) untuk melihat pergerakan traffic secara real-time!")
